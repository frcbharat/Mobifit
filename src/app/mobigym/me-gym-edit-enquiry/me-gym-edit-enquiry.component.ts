...
export class MeGymEditEnquiryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.callHttpPost.makeRequest_getEnquiry(this.getAPIResponseObject).subscribe(
      ...
      this.enquiry_status.valueChanges.subscribe(
        (value : any) => {
        if(value =='CONTACT IN FUTURE' || value == 'ONHOLD' || value == 'INTERESTED'){
  ...
  onSubmit(value: string) {
    ...
    console.log('Enquiryfollowup',this.Enquiryfollowup);
  ...
  AddEnquieryFollowUp(){
    ...
    let Object: any = {
      ...
      "enquiry_fname" : null,
      "enquiry_Date" : null,
      "enquiry_activity" : null
       }
      Object.enquiry_activity =this.EditenquiryForm.controls['activity'].value;
      Object.enquiry_name =this.EditenquiryForm.controls['first_name'].value;
      Object.enquiry_id=this.EditenquiryForm.controls['enquiry_num'].value; 
      Object.enquiry_Date=this.EditenquiryForm.controls['enquiry_date'].value;
