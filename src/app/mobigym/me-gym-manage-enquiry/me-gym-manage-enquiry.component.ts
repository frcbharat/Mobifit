...
export class MeGymManageEnquiryComponent implements OnInit {
  ...
  columns: ITdDataTableColumn[] = [
    { name: 'enquiry_num',  label: 'Enquiry Num', width: 100 },
    { name: 'full_name',  label: 'Full name', width: 150 }, 
    { name: 'enquiry_date', label: 'Enquiry Date', width: { min: 150, max: 200 }},
    ...
    //{ name: 'followup_enquiry_date', label: 'Follow-Up-Date', width:{ min: 150, max: 200 }},  
